...
const DISCLAIMER_ITEMS = [
  "Onchain Pulse is an independent, unofficial interface for viewing public wallet data, portfolio positions, and third-party DeFi market data relating to the Monad ecosystem.",
...
export function DisclaimerModal() {
  ...
  return (
    <div
      ...
      role="dialog"
      aria-modal="true"
      aria-label="Onchain Pulse disclaimer"
    >
